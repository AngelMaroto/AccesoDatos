...
El lenguaje de consulta de Hibernate (HQL) y el lenguaje de consulta de persistencia de Java (JPQL)
 ...
 Una consulta JPQL siempre es una consulta HQL válida, sin embargo, lo contrario no es cierto.
    ...
    public List<User> findAll() {
        ...
        //Nosotros hasta ahora trabajamos de esta forma, para HIbernate
        // vamos a simpilicarlo y que se pueda utilizar para todos JPA utilizando entityManager.unwrap
...
/*
        ...
        //Aunque HQL no requiere la presencia de una clausa select generalmente es recomendable incluir uno
        Query<User> consultaHQL = currentSession.createQuery("SELECT u from User u", User.class);

        List<User> users = consultaHQL.getResultList();
    ...
    public User findByEmail(String email) {
        ...
        Query consultaHQL = currentSession.createQuery("SELECT u from User u where u.email = :email", User.class);

        consultaHQL.setParameter("email", email);
        User user = (User) consultaHQL.getSingleResult();
        return user;
    }
 ...
 */
    ...
    public void deleteById(int id) {
        ...
        Query consultaHQL = currentSession.createQuery("delete from User u where id IN (:idUser)");

        consultaHQL.setParameter("idUser", id);
        consultaHQL.executeUpdate();
        t.commit();
        currentSession.close();
    ...
    public void deleteByEmail(String email) {
        ...
        Query consultaHQL = currentSession.createQuery("delete from User u where u.email IN (:email)");
